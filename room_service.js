...
const ValidateAndExtractRoomID = function (room_id, errorCallback)
{
    if (room_id.length != 5)
    {
...
const GetRoomByID = function (room_id, foundCallback, missingCallback, errorCallback)
{
